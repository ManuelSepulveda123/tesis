                ...
                <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        ...
                        <ul class="kt-menu__nav ">
                            ...
                            @else
                            <li id="clases_nav" class="kt-menu__item" aria-haspopup="true"><a href="{{route('curso_profesor',auth()->user()->id)}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Clases</span></a></li>
                            <li id="estudiantes_nav" class="kt-menu__item " aria-haspopup="true"><a href="{{route('lista_estudiantes',auth()->user()->id)}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Estudiantes</span></a></li>
                            <li id="tareas_nav" class="kt-menu__item " aria-haspopup="true"><a href="{{route('tareas_curso',auth()->user()->id)}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Tareas</span></a></li>
                            @endif
                            ...
                            <li class="kt-menu__section ">
                                <h4 class="kt-menu__section-text">Mis Cursos</h4>
                                <i class="kt-menu__section-icon flaticon-more-v2"></i>
                            </li>

                            @foreach($cursos as $curso)

                            <li id="curso_{{$curso->id_curso}}" class="kt-menu__item " aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span></span></i><span class="kt-menu__link-text">{{$curso->curso}}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li id="clases_nav2_{{$curso->id_curso}}" class="kt-menu__item" aria-haspopup="true"><a href="{{route('curso_profesor',$curso->id_curso)}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Clases</span></a></li>
                                        <li id="estudiantes_nav2_{{$curso->id_curso}}" class="kt-menu__item " aria-haspopup="true"><a href="{{route('lista_estudiantes',$curso->id_curso)}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Estudiantes</span></a></li>
                                        <li id="tareas_nav2_{{$curso->id_curso}}" class="kt-menu__item " aria-haspopup="true"><a href="{{route('tareas_curso',$curso->id_curso)}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Tareas</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="kt-menu__section ">
                                <h4 class="kt-menu__section-text">Materias</h4>
                                <i class="kt-menu__section-icon flaticon-more-v2"></i>
                            </li>
                            @if(isset($materias_estudiante))

                            @foreach($materias_estudiante as $materia)
                            <li class="kt-menu__item " id="{{$materia->id_materia}}" aria-haspopup="true"><a href="{{route('estudiante_materia',$materia->id_materia )}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">{{$materia->materia}}</span></a></li>
                            @endforeach
